/**
 * js/data/psgc-data.js
 * Local, offline PSGC (Philippine Standard Geographic Code) dataset —
 * scoped to the regions Go! Cery actually delivers to (Metro Manila / NCR
 * and Rizal province, see CONFIG.deliveryZones). Sourced from the 2019
 * PSGC dataset (philippine_provinces_cities_municipalities_and_barangays_2019v2.json),
 * trimmed to just these two regions. Used by js/modules/psgc.js.
 */
const PSGC_DATA = {
  "RIZAL": {
    "municipality_list": {
